    ...
    <div class="container mx-auto md:px-16 py-10">
      <div class="flex text-center md:text-left md:flex-row mt-20">
        <div class="flex flex-col items-left md:w-1/">
          <div class="text-2xl md:text-5xl font-medium">Soft Service Solutions</div>
        </div>
      </div>
      <div>
      <div
       ...
       <div class="flex flex-col px-14 py-5">
          <div class="flex-1">
            <div class="flex items-center">
              ...
              <h3 class="font-bold text-xl">Housekeeping Service</h3>
            </div>
        ...
        <div class="flex flex-col px-14 py-5">
          <div class="flex-1">
            <div class="flex items-center">
              ...
              <h3 class="font-bold text-xl">Pantry Management</h3>
            </div>
        ...
        <div class="flex flex-col px-14 py-5">
          <div class="flex-1">
            <div class="flex items-center">
              ...
              <h3 class="font-bold text-xl">Waste Management</h3>
            </div>
    ...
    <div class="container bg-darkBlue text-white mx-auto md:px-16 py-20">
      <div class="flex flex-col text-center md:text-left md:flex-row">
        ...
        <div
          ...
          "
        >
        <p class="mt-8 text-lg md:text-2xl">
  ...
  data(){
    return {
      solutions:[
        ...
        {
          title:'Horticulture',
          description:'Horticulture services include gardening responsibilities, such as planting and maintaining shrubs, trees, and lawn areas to beautify and enhance the outlook of your facility. Our gardening team specialises in mowing, pruning, and fertilizing, as well as clutter disposal services, like removing brush and unwanted layers of debris.'
        },
        {
          title:'Carpet Shampooing',
          description:'Carpet shampooing is required to remove thick dirt, mud, grime and other unwanted substances. We offer specially formulated carpet shampooing services to remove pet stains, odours, food stains, musty smells and elongate the life of the fabric.'
        },
        {
          title:'Project Cleaning',
          description:'We offer one-time comprehensive project cleaning services that help promote healthy work environments and keep your buildings tidy and well maintained.'
        },
      ],
    }
  }
